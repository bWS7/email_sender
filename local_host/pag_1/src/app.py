...
import os
from datetime import datetime  # Importando para registrar a data e hora
...
def gerar_dados():
    dados_colaboradores = [
        {'id': 1, 'nome': 'Bruno', 'email': 'brunowsantos15@gmail.com', 'anexo': 'C:\\Users\\Usuario\\Desktop\\local_host\\pag_1\\src\\uploads\\nota_bruno.pdf', 'supervisor': 'bruno.alves@sousaaraujo.com.br'},
        {'id': 2, 'nome': 'Kamille', 'email': 'kamillebenedito@gmail.com', 'anexo': 'C:\\Users\\Usuario\\Desktop\\upload_notas\\nota_bruno.pdf', 'supervisor': 'bruno.alves@sousaaraujo.com.br'},
    ]
    return dados_colaboradores

# Inicializar lista para armazenar e-mails enviados
emails_enviados = []
    ...
    if id_colaborador:
        ...
        if colaborador:
            ...
            emails_enviados.append({
                ...
                'data_envio': datetime.now().strftime('%Y-%m-%d %H:%M:%S')  # Data e hora do envio
            })
        else:
        ...
        for colaborador in colaboradores:
            ...
            emails_enviados.append({
                ...
                'nome': colaborador['nome'],
                'email': colaborador['email'],
                'data_envio': datetime.now().strftime('%d/%m/%Y %H:%M')  # Data e hora do envio
            })
